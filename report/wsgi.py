...
from report.i18n import _, _LE, _LI
...
class Server(object):
    ...
    def __init__(self, name, app, host='0.0.0.0', port=0, pool_size=None,
        ...
        self._logger = logging.getLogger("report.%s.wsgi.server" % self.name)
    ...
    def start(self):
        ...
        if self._use_ssl:
            try:
                ...
                if self._uses_ssl and (not cert_file or not key_file):
...
class Router(object):
    ...
    def __call__(self, req):
        ...
        """
        LOG.debug("Router __call__,  req:" + str(req))
        return self._router
    ...
    def _dispatch(req):
        ...
        """
        LOG.debug("Router _dispatch, req:" + str(req))
